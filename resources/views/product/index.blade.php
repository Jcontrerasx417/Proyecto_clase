...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen flex flex-col">
  ...
  <!-- =========================================================
       FILTER BAR — Category pills + results count
       ========================================================= -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0">
          <button class="bg-primary/20 text-primary border border-primary/30 px-4 py-1.5 rounded-full
                         text-xs font-semibold whitespace-nowrap">
            All Products
          </button>
          <button class="bg-white/5 hover:bg-white/10 text-slate-300 px-4 py-1.5 rounded-full
  ...
  <main class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      ...
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        <div class="relative aspect-video bg-slate-800 overflow-hidden">
          ...
          <div
            ...
            data-alt="High-end RTX 4090 graphics card close up"
          ></div>
          <span class="absolute top-3 left-3 bg-primary text-background-dark text-[10px] font-black
        ...
        <div class="p-5 flex flex-col flex-grow">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            24GB GDDR6X, Triple Fan Cooling, DLSS 3.0 Support, 4th Gen Tensor Cores.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
              Add to Cart
            </button>
            <button class="px-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg
      ...
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        ...
        <div class="p-5 flex flex-col flex-grow">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            240Hz Refresh Rate, 0.03ms GtG, 99% DCI-P3, HDR1000, Ultra-wide 1440p.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
      ...
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        <div class="relative aspect-video bg-slate-800 overflow-hidden">
          ...
          <div
            ...
            data-alt="Sleek silver gaming laptop open on desk"
          ></div>
          <span class="absolute top-3 left-3 bg-red-500 text-white text-[10px] font-black
                       px-2 py-0.5 rounded uppercase tracking-wider">
            Hot
          </span>
        </div>
        <div class="p-5 flex flex-col flex-grow">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            Intel Core i9-13980HX, 64GB DDR5, RTX 4080 Mobile, 2TB NVMe Gen4 SSD.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
      ...
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        ...
        <div class="p-5 flex flex-col flex-grow">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            Hot-swappable Mechanical Switches, PBT Keycaps, Per-key RGB, CNC Aluminum.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
      ...
      <!-- ── Card 5: Titan Liquid CPU Cooler ── -->
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        <div class="relative aspect-video bg-slate-800 overflow-hidden">
          <div class="absolute inset-0 bg-gradient-to-t from-background-dark/80 to-transparent"></div>
          <div
            ...
            data-alt="High performance water-cooled PC tower"
          ></div>
        </div>
        <div class="p-5 flex flex-col flex-grow">
          <div class="flex justify-between items-start mb-2">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            360mm Radiator, LCD Pump Head Display, High-Static Pressure Silent Fans.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
      ...
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        ...
        <div class="p-5 flex flex-col flex-grow">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            Ultra-lightweight 54g, 30K DPI Sensor, 100hr Battery, Zero Latency Wireless.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
      ...
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        <div class="relative aspect-video bg-slate-800 overflow-hidden">
          ...
          <div
            ...
            data-alt="High-speed DDR5 RAM modules with RGB"
          ></div>
        </div>
        <div class="p-5 flex flex-col flex-grow">
          <div class="flex justify-between items-start mb-2">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            6400MT/s Speed, Low Latency CL32, Heatsink with Customizable RGB Strips.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
      ...
      <div class="product-card bg-white/5 border border-white/10 rounded-xl overflow-hidden flex flex-col group">
        <div class="relative aspect-video bg-slate-800 overflow-hidden">
          ...
          <div
            ...
            data-alt="Professional studio microphone for streaming"
          ></div>
        </div>
        <div class="p-5 flex flex-col flex-grow">
          <div class="flex justify-between items-start mb-2">
          ...
          <p class="text-slate-400 text-sm mb-6 flex-grow">
            Professional Condenser Mic, Boom Arm, Pop Filter, and Audio Interface Bundle.
          </p>
          <div class="flex gap-2">
            <button class="flex-grow bg-primary hover:bg-primary/90 text-background-dark py-2 rounded-lg
                           text-sm font-bold transition-all">
    ...
    <div class="mt-12 flex justify-center">
      <nav class="flex items-center gap-2">
        <button class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5
                       text-slate-400 hover:bg-white/10 transition-colors">
          <span class="material-symbols-outlined">chevron_left</span>
        </button>
        <button class="w-10 h-10 flex items-center justify-center rounded-lg bg-primary
                       text-background-dark font-bold">1</button>
        <button class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5
                       text-slate-400 hover:bg-white/10 transition-colors">2</button>
        <button class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5
                       text-slate-400 hover:bg-white/10 transition-colors">3</button>
        <span class="text-slate-600 px-2">...</span>
        <button class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5
                       text-slate-400 hover:bg-white/10 transition-colors">6</button>
        <button class="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5
                       text-slate-400 hover:bg-white/10 transition-colors">
