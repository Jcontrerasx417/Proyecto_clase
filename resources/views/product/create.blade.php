...
<style>
        ...
        .form-glow:focus-within {
            box-shadow: 0 0 15px rgba(13, 185, 242, 0.15);
        }
    </style>
</head>
...
<img alt="User profile" class="w-full h-full object-cover rounded-full" data-alt="Professional user profile avatar photo" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC-wk9V0PqkeCxtXERiJPkMOGBhKQesv19ajoj8cmirYdgxWDX9zqDVe9oi2_o1kSV7oWI6VFnHias-0172JnJl_0KnwtRH-VF2Dgb9pPbuu0FhnOfoHcUdnBsdWlmu6HJCZPFBEspMDEcR1rtxLJdMEU6z0Le17ApG6cC3IX2aYt8axCeGhBxmDn31R95UQheBsq9azxH0g0y4JiUqvM0S92xBDkapJMYWJ49W-U88AkVw2g-EWwbyoqS2q96HfxYFdzvfpav3UjTQ"/>
</div>
</div>
</div>
</header>
...
<label class="block text-sm font-bold text-slate-300 mb-2 group-focus-within:text-primary transition-colors">Nombre del Producto</label>
<input class="w-full bg-[#162226] border border-[#3b4e54] rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-500" placeholder="Ej: NVIDIA GeForce RTX 4090 Founders Edition" type="text"/>
</div>
<!-- Precio -->
<div class="group">
<label class="block text-sm font-bold text-slate-300 mb-2 group-focus-within:text-primary transition-colors">Precio de Venta</label>
<div class="relative">
<span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-medium">$</span>
<input class="w-full bg-[#162226] border border-[#3b4e54] rounded-lg pl-8 pr-4 py-3 text-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-500" placeholder="0.00" type="number"/>
</div>
</div>
<!-- Estado -->
<div class="group">
<label class="block text-sm font-bold text-slate-300 mb-2 group-focus-within:text-primary transition-colors">Estado del Equipo</label>
<select class="w-full bg-[#162226] border border-[#3b4e54] rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all appearance-none">
...
<!-- Descripción -->
<div class="md:col-span-2 group">
<label class="block text-sm font-bold text-slate-300 mb-2 group-focus-within:text-primary transition-colors">Descripción Detallada</label>
<textarea class="w-full bg-[#162226] border border-[#3b4e54] rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-slate-500 resize-none" placeholder="Especificaciones técnicas, tiempo de uso, motivos de venta..." rows="5"></textarea>
</div>
<!-- Imagen (File Upload) -->
<div class="md:col-span-2">
<label class="block text-sm font-bold text-slate-300 mb-2">Imágenes del Producto</label>
<div class="border-2 border-dashed border-[#3b4e54] rounded-xl p-10 flex flex-col items-center justify-center bg-[#162226]/50 hover:bg-[#162226] hover:border-primary transition-all cursor-pointer">
<label class="flex flex-col items-center justify-center w-full h-full cursor-pointer group/upload">
<span class="material-symbols-outlined text-primary text-5xl mb-3 group-hover/upload:scale-110 transition-transform">cloud_upload</span>
...
<button class="w-full bg-primary hover:brightness-110 text-background-dark font-black py-4 rounded-xl text-lg flex items-center justify-center gap-2 transition-all shadow-lg shadow-primary/20" type="submit">
...
<strong class="text-slate-200">Consejo Pro:</strong> Los productos con descripciones detalladas y más de 3 fotos claras se venden un <span class="text-primary font-bold">45% más rápido</span>.
                </p>
</div>
</div>
</main>
